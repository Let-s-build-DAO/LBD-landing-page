    ...
    <>
      ...
      <section id='about' className='lg:mx-10 mx-6'>
        <div className='lg:w-[40%] mx-auto text-center py-40'>
          ...
          <h4 className='text-5xl font-bold'>Building a global on‑chain future</h4>
        </div>
        <div className='lg:flex justify-between'>
          <img className='lg:w-[45%] mr-auto' src="/images/about.png" alt="" />
          <div className='my-auto lg:mt-0 mt-6  lg:w-1/2'>
            <p>Who We Are</p>
            <h3 className='lg:text-5xl text-3xl my-3 font-bold'>Building an inclusive, global Web3 future using on‑chain intelligence</h3>
            <p className='text-[#CDCDCD] text-lg'>LB DAO accelerates meaningful Web3 adoption through on‑chain intelligence: collecting, analyzing, and leveraging transaction data to inform funding, governance, and product decisions. Our data‑first approach ensures resources go to solutions that work for diverse communities.
              <br /> <br />
              We build participatory infrastructure so people worldwide can access, use, and govern blockchain technology.</p>
          </div>
        </div>
      </section>
      <section className='my-20 lg:mx-10 mx-6'>
        <div className='lg:w-[55%] my-10'>
          <p>What We Do</p>
          <h3 className='lg:text-5xl text-3xl font-bold'>Empowering the world with data‑driven Web3 solutions</h3>
        </div>
          ...
          <div className='lg:w-[32%] rounded-[24px] overflow-hidden'>
            <div className='linear'>
              ...
              <div className='p-4'>
                ...
                <p>We monitor blockchain transactions worldwide to identify trends, gaps, and opportunities.</p>
              </div>
            </div>
          </div>
          <div className='lg:w-[32%] rounded-[24px] overflow-hidden '>
          ...
          <div className='lg:w-[32%] rounded-[24px] overflow-hidden'>
            <div className='linear'>
              ...
              <div className='p-4'>
                ...
                <p>Helping communities worldwide transition into the global Web3 economy by driving adoption and investment.</p>
              </div>
            </div>
          </div>
        </div>
